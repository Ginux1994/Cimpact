...
int main1(){
	...
	fem.parseConstraint_BdCondition(consList);
	vector<Rigid_Body> rigidConsList;
	fem.parseConstraint_RigidCondition(rigidConsList);
	...
	int num = fem.parseNodeVectorAndTable(nodeList, nodeTable, consList,rigidConsList, loadList);
